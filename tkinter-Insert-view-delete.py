...
#----------------------------------------------------------------------------------------
    ...
    c.execute(sql, val)
    conn.commit()
    l12=Label(w,text="Record Inserted Successfully!!!!!")
...
def delete():
          ...
          l8=Label(w,text="Record deleted successfully!!!!!!!!!!")
          l8.place(x=150,y=650)
          conn.commit()
#-----------------------------------------------------------------------------------------------------------------------
l10=Label(w,text="Registration Form by Prathamesh-", font=("Helvetica", 22), fg="orange", bg="black")
l10.place(x = 20,y = 20)
#------------------------------------------------------------------------------------------------------------------------
...
l8.place(x=100,y=580)
e6=Entry(w)
e6.place(x=280,y=580)
#---------------------------------------------------------------------------------------------------------------
